...
//}
//
//void MVMultiplicationSparse(size_t poly_modulus_degree)
//{
...
//                else
//                {
//                    pod_matrix1_set2[i][j] = 0;
//                    pod_matrix2_set2[i][j] = 0;
//
//                }
//            }            
//            else
...
//    print_full_matrix(pod_matrix1_set2);
//    print_full_matrix(pod_matrix2_set2);
//    
//    // Get all diagonals
//
//    // Set 2
...
//    print_error_difference(output_result_set2, expectedvector2, dimension2);
//
//    outf.close();
//}
//
