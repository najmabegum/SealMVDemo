...
int main()
{
    ...
    while (true)
    {
        ...
        cout << "| 6.  Matrix Vector Multiplication - Dense 1 matrix (Max Normalised and MSE) (With rescale)                    |" << endl;
        cout << "| 7.  Matrix Vector Multiplication - Dense 1 matrix (Max Normalised and MSE) (Without rescale)                 |" << endl;
        cout << "| 8.  Matrix Vector Multiplication - Dense (Max Normalised and MSE) (With rescale)                             |" << endl;
        cout << "| 9.  Matrix Vector Multiplication - Dense (Max Normalised and MSE) (Without rescale)                          |" << endl;
        cout << "+----------------------------+---------------------------------------------------------------------------------+" << endl;
        ...
        {
        case 1:
            // input matrix is increasing scale up to max value dimension*dimension
            MVMultiplicationDense(10,true);
            break;

        case 2:
            // input marix in increasing scale upto max value dimension*dimension
            MVMultiplicationDense(10, false);
            break;
